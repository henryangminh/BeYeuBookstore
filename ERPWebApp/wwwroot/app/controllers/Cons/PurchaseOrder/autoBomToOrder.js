function autoBom(inp, arr) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        closeAllLists();
        inp.setAttribute('data-code', '');
        $('#txtSelectCode').val('').change();
        if (!val) { isAll = true; }
        currentFocus = -1;
        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (index > -1) {
                ...
                b.addEventListener("click", function (e) {
                    ...
                    var code = this.getElementsByTagName("input")[0].getAttribute('data-code');
                    inp.setAttribute('data-code', code);
                    $('#txtSelectCode').val(code).change();
