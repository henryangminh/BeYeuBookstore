               ...
               result = _userManager.CreateAsync(new User()
                ...
                if (_context.InvoiceDetails.Count() == 0)
                {
                    _context.InvoiceDetails.AddRange(new List<InvoiceDetail>()
                    {
                            ...
                            new InvoiceDetail(){ InvoiceFK=11,BookFK=19,Qty=3,SubTotal=234000},
                            new InvoiceDetail(){ InvoiceFK=11,BookFK=18,Qty=3,SubTotal=480000},
                ...
                if (_context.Deliveries.Count() == 0)
                {
                    _context.Deliveries.AddRange(new List<Delivery>()
                    {
                            ...
                            new Delivery(){ InvoiceFK=4,MerchantFK=6,DeliveryStatus=Const_DeliStatus.OnDelivery, OrderPrice=120000,ShipPrice=15000},
                            ...
                            new Delivery(){ InvoiceFK=11,MerchantFK=6,DeliveryStatus=Const_DeliStatus.Packaged, OrderPrice=234000,ShipPrice=15000},
                            new Delivery(){ InvoiceFK=11,MerchantFK=5,DeliveryStatus=Const_DeliStatus.Success, OrderPrice=480000,ShipPrice=20000},
