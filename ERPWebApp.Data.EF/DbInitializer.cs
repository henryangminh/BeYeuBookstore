            ...
            if (_userManager.Users.Count() == 0)
            {
               ...
               result = _userManager.CreateAsync(new User()
                ...
                if (_context.Invoices.Count() == 0)
                {
                    ...
                    {
                            new Invoice(){ CustomerFK=1,TotalPrice=358000,DeliAddress="Lầu 19 Landmark 81 Q.Bình Thạnh", DeliContactName="Mỡ's Má", DeliContactHotline="0908468188"},
                            new Invoice(){ CustomerFK=1,TotalPrice=89000,DeliAddress="Lầu 19 Landmark 81 Q.Bình Thạnh", DeliContactName="Mỡ's Ba", DeliContactHotline="0908466048"},
                            new Invoice(){ CustomerFK=2,TotalPrice=227000,DeliAddress="26 Nguyễn Trãi Q.3", DeliContactName="Con Cá", DeliContactHotline="0908468183"},
                            new Invoice(){ CustomerFK=3,TotalPrice=124000,DeliAddress="07 Pasteur Q3", DeliContactName="UTS Bi", DeliContactHotline="0908468182"},
                            new Invoice(){ CustomerFK=4,TotalPrice=207000,DeliAddress="12 Trần Hưng Đạo Q.5", DeliContactName="Bánh Mì", DeliContactHotline="0908468908"},
                            new Invoice(){ CustomerFK=4,TotalPrice=190000,DeliAddress="12 Trần Hưng Đạo Q.5", DeliContactName="Bánh Mì", DeliContactHotline="0908468908"},
                            new Invoice(){ CustomerFK=5,TotalPrice=116000,DeliAddress="02 Phạm Hùng Q.8", DeliContactName="Phát Tài", DeliContactHotline="0908221882"},
                            new Invoice(){ CustomerFK=6,TotalPrice=196000,DeliAddress="45 Nguyễn Hữu Cảnh Q.Bình Thạnh", DeliContactName="Thành công", DeliContactHotline="0938368188"},
                            new Invoice(){ CustomerFK=7,TotalPrice=155000,DeliAddress="17 Chung cư Trần Quang Khải Q.1", DeliContactName="Minh Khánh", DeliContactHotline="0908338188"},
                            new Invoice(){ CustomerFK=7,TotalPrice=60000,DeliAddress="17 Chung cư Trần Quang Khải Q.1", DeliContactName="Minh Anh", DeliContactHotline="0908463388"},
                            new Invoice(){ CustomerFK=8,TotalPrice=714000,DeliAddress="03 Trương Định Q.3", DeliContactName="Hùng Em", DeliContactHotline="0908468133"},
                            new Invoice(){ CustomerFK=9,TotalPrice=190000,DeliAddress="19 Nam Kỳ Khởi Nghĩa", DeliContactName="Linh Linh", DeliContactHotline="0908338188"},
                            new Invoice(){ CustomerFK=10,TotalPrice=98000,DeliAddress="20 Đinh Công Tráng Q.1", DeliContactName="Hồng Thu", DeliContactHotline="0908468228"},
                            new Invoice(){ CustomerFK=10,TotalPrice=316000,DeliAddress="20 Đinh Công Tráng Q.1", DeliContactName="Hồng Thịnh", DeliContactHotline="0908462288"},
                     });
                ...
                if (_context.InvoiceDetails.Count() == 0)
                {
                    ...
                    {
                            new InvoiceDetail(){ InvoiceFK=1,BookFK=1,Qty=2,SubTotal=298000},
                            new InvoiceDetail(){ InvoiceFK=1,BookFK=2,Qty=2,SubTotal=60000},
                            new InvoiceDetail(){ InvoiceFK=2,BookFK=3,Qty=1,SubTotal=89000},
                            new InvoiceDetail(){ InvoiceFK=3,BookFK=4,Qty=1,SubTotal=118000},
                            new InvoiceDetail(){ InvoiceFK=3,BookFK=5,Qty=1,SubTotal=109000},
                            new InvoiceDetail(){ InvoiceFK=4,BookFK=6,Qty=2,SubTotal=124000},
                            new InvoiceDetail(){ InvoiceFK=5,BookFK=3,Qty=1,SubTotal=89000},
                            new InvoiceDetail(){ InvoiceFK=5,BookFK=4,Qty=1,SubTotal=118000},
                            new InvoiceDetail(){ InvoiceFK=6,BookFK=7,Qty=2,SubTotal=190000},
                            new InvoiceDetail(){ InvoiceFK=7,BookFK=11,Qty=1,SubTotal=98000},
                            new InvoiceDetail(){ InvoiceFK=7,BookFK=17,Qty=1,SubTotal=18000},
                            new InvoiceDetail(){ InvoiceFK=8,BookFK=13,Qty=2,SubTotal=196000},
                            new InvoiceDetail(){ InvoiceFK=9,BookFK=12,Qty=1,SubTotal=95000},
                            new InvoiceDetail(){ InvoiceFK=9,BookFK=16,Qty=1,SubTotal=60000},
                            new InvoiceDetail(){ InvoiceFK=10,BookFK=15,Qty=2,SubTotal=60000},
                            new InvoiceDetail(){ InvoiceFK=11,BookFK=19,Qty=3,SubTotal=480000},
                            new InvoiceDetail(){ InvoiceFK=11,BookFK=18,Qty=3,SubTotal=234000},
                            new InvoiceDetail(){ InvoiceFK=12,BookFK=12,Qty=2,SubTotal=190000},
                            new InvoiceDetail(){ InvoiceFK=13,BookFK=11,Qty=1,SubTotal=98000},
                            new InvoiceDetail(){ InvoiceFK=14,BookFK=18,Qty=2,SubTotal=156000},
                            new InvoiceDetail(){ InvoiceFK=14,BookFK=19,Qty=1,SubTotal=160000},
                    });
                ...
                if (_context.Deliveries.Count() == 0)
                {
                    ...
                    {
                            new Delivery(){ InvoiceFK=1,MerchantFK=1,DeliveryStatus=Const_DeliStatus.Confirmed, OrderPrice=298000,ShipPrice=15000,},
                            new Delivery(){ InvoiceFK=1,MerchantFK=2,DeliveryStatus=Const_DeliStatus.OnDelivery, OrderPrice=60000, ShipPrice=15000},
                            new Delivery(){ InvoiceFK=2,MerchantFK=1,DeliveryStatus=Const_DeliStatus.Packaged, OrderPrice=89000, ShipPrice=15000},
                            new Delivery(){ InvoiceFK=3,MerchantFK=2,DeliveryStatus=Const_DeliStatus.Success, OrderPrice=118000,ShipPrice=20000},
                            new Delivery(){ InvoiceFK=3,MerchantFK=1,DeliveryStatus=Const_DeliStatus.UnConfirmed, OrderPrice=109000},
                            new Delivery(){ InvoiceFK=4,MerchantFK=2,DeliveryStatus=Const_DeliStatus.OnDelivery, OrderPrice=124000,ShipPrice=15000},
                            new Delivery(){ InvoiceFK=5,MerchantFK=1,DeliveryStatus=Const_DeliStatus.Fail, OrderPrice=89000, ShipPrice=15000},
                            new Delivery(){ InvoiceFK=5,MerchantFK=4,DeliveryStatus=Const_DeliStatus.UnConfirmed, OrderPrice=118000},
                            new Delivery(){ InvoiceFK=6,MerchantFK=1,DeliveryStatus=Const_DeliStatus.Confirmed, OrderPrice=190000, ShipPrice=10000},
                            new Delivery(){ InvoiceFK=7,MerchantFK=1,DeliveryStatus=Const_DeliStatus.UnConfirmed, OrderPrice=98000},
                            new Delivery(){ InvoiceFK=7,MerchantFK=4,DeliveryStatus=Const_DeliStatus.Packaged, OrderPrice=18000, ShipPrice=15000},
                            new Delivery(){ InvoiceFK=8,MerchantFK=1,DeliveryStatus=Const_DeliStatus.Success, OrderPrice=196000, ShipPrice=20000},
                            new Delivery(){ InvoiceFK=9,MerchantFK=2,DeliveryStatus=Const_DeliStatus.Confirmed, OrderPrice=95000, ShipPrice=10000},
                            new Delivery(){ InvoiceFK=9,MerchantFK=3,DeliveryStatus=Const_DeliStatus.Fail, OrderPrice=60000, ShipPrice=10000},
                            new Delivery(){ InvoiceFK=10,MerchantFK=1,DeliveryStatus=Const_DeliStatus.OnDelivery, OrderPrice=60000,ShipPrice=20000},
                            new Delivery(){ InvoiceFK=11,MerchantFK=6,DeliveryStatus=Const_DeliStatus.Packaged, OrderPrice=480000,ShipPrice=15000},
                            new Delivery(){ InvoiceFK=11,MerchantFK=5,DeliveryStatus=Const_DeliStatus.Success, OrderPrice=234000,ShipPrice=20000},
                            new Delivery(){ InvoiceFK=12,MerchantFK=2,DeliveryStatus=Const_DeliStatus.Confirmed, OrderPrice=190000,ShipPrice=25000},
                            new Delivery(){ InvoiceFK=13,MerchantFK=1,DeliveryStatus=Const_DeliStatus.OnDelivery, OrderPrice=98000,ShipPrice=30000},
                            new Delivery(){ InvoiceFK=14,MerchantFK=5,DeliveryStatus=Const_DeliStatus.UnConfirmed, OrderPrice=156000},
                            new Delivery(){ InvoiceFK=14,MerchantFK=6,DeliveryStatus=Const_DeliStatus.UnConfirmed, OrderPrice=160000 }
                    });
