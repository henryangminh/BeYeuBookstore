    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (_userManager.Users.Count() == 0)
            {
                ...
                {
                    new AdvertisementContent(){AdvertisementPositionFK=1, AdvertiserFK=1, Title="Bút Thiên Long", Description="Bút TL mua 3 tặng chục", UrlToAdvertisement="thienloi.vn", Deposite=2000000, PaidDeposite=false, CensorStatus=CensorStatus.Uncensored },
                    new AdvertisementContent(){AdvertisementPositionFK=3,AdvertiserFK=2, Title="Bao sách Viết Hưng", Description="Bao sách khuyến mãi mùa học lại mua 10 tặng 1", UrlToAdvertisement="viethung.vn", Deposite=2000000, PaidDeposite=false, CensorStatus=CensorStatus.Uncensored},
                    new AdvertisementContent(){AdvertisementPositionFK=2, AdvertiserFK=4, Title="Tiki", Description="Săn sách giá rẻ",UrlToAdvertisement="tiki.vn",Deposite=2000000, PaidDeposite=false, CensorStatus=CensorStatus.Uncensored, },
