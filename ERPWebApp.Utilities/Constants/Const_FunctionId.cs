   ...
   public class Const_FunctionId
    {
		...
		public const string InventoryRetail = "InventoryRetailItem";
		public const string InvoiceRetail = "InvoiceRetailItem";
		public const string ProductCons = "ProductConsItem";
		public const string ProductRetail = "ProductRetailItem";
		public const string ProjectCons = "ProjectConsItem";
		public const string PurchaseOrderCons = "PurchaseOrderItem";
		public const string Role = "RoleItem";
		public const string SalesOrderRetail = "SalesOrderRetailItem";
		public const string StatementPayment = "StatementPaymentItem";
		public const string SynthesisBom = "SynthesisBomItem";
        public const string AllowedVacation = "AllowedVacationItem";
        ...
        public const string AdStatistic = "AdStatisticsItem";
